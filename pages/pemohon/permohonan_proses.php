...
// {
//     $query = "SELECT p.id, p.nomor_permohonan, p.tanggal_permohonan, p.status2, u.name AS nama_pemohon
//               FROM permohonan p
...
//     return $result;
// }
function getAllRequestsUser($conn, $user_id)
{
    $query = "SELECT p.id, 
                     p.nomor_permohonan, 
              ...
              WHERE p.user_id = ? AND p.status2 = 7
              ORDER BY p.created_at DESC";
...
$requests = getAllRequestsUser($conn, $_SESSION['user_id']); ?>
<!DOCTYPE html>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a href="http://localhost/sipatra2025/cetak_permohonan.php?id=<?= $row['id']; ?>"
                                                        class="btn btn-success btn-sm">
                                                        📑 cetak
                                                    </a> -->

                                                    <!-- ini ok hanya saya ubah ke cetak_permohonan.php -->

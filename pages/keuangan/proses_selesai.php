                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="#" class="text-muted">Keuangan
                                            Dashboard</a><br></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Permohonan Selesai
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">
                                    Menampilkan Data Permohonan yang telah selesai
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index.php?page=detail_proses_selesai&id=<?= $row['id']; ?>"

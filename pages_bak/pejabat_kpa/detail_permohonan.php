                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <h3>E-Sign Pemohon</h3>
                                    <img src="<?= htmlspecialchars($permohonan['qr_code_pemohon']); ?>" alt="QR Code"
                                        width="100">
                                    <?php if (!empty($permohonan['qr_code_ppk'])): ?>
                                    <h3>E-Sign PPK</h3>
                                    <img src="<?= htmlspecialchars($permohonan['qr_code_ppk']); ?>" alt="QR Code"
                                        width="100">
                                    <?php endif; ?>
                                    <?php if (!empty($permohonan['qr_code_kpa'])): ?>
                                    <h3>E-Sign KPA</h3>
                                    <img src="<?= htmlspecialchars($permohonan['qr_code_kpa']); ?>" alt="QR Code"
                                        width="100">
                                    <?php endif; ?> <div class="form-actions">

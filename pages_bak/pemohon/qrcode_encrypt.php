...
$secretKey = "KunciRahasiaSuperAman";

// Generate token verifikasi
$token = hash_hmac('sha256', $nomor_permohonan . $nama_pemohon . $tanggal_permohonan, $secretKey);

// Data yang dimasukkan ke dalam QR Code (URL untuk verifikasi)
$qrData = "https://domainanda.com/verify.php?id=$nomor_permohonan&token=$token";
